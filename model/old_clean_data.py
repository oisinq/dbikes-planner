...
f.write(
    "available_bike_stands,time_of_day,type_of_day,day_of_year,iso_date,temperature,relative_humidity,vapour_pressure,wind_speed,rain,sunshine,visibility,category\n")
...
for line in my_data.sort_values('last_update').values:
    ...
    f.write(f"{available_bikes},{datetime_to_seconds(entry_datetime)},{day_type}," + \
            f"{entry_datetime.timetuple().tm_yday},{entry_datetime.isoformat()},{weather_line[4]},{weather_line[9]},{weather_line[8]},{weather_line[12]},{weather_line[2]},{weather_line[17]},{weather_line[18]},{category(available_bikes)}\n")
    ...
    #     f"{entry_datetime.timetuple().tm_yday},{entry_datetime.isoformat()},{weather_line[4]},{weather_line[9]},{weather_line[8]},{weather_line[12]},{weather_line[2]},{category(available_bikes)}\n")
