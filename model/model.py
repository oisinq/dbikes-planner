...
attributes = ['time_of_day', 'type_of_day', 'day_of_year', 'temperature', 'rain', 'relative_humidity', 'vapour_pressure', 'wind_speed', 'sunshine', 'visibility', 'change_in_bike_availability']
X = my_data[attributes].values
y = my_data['available_bike_stands'].values

#display_bike_availability_over_time(my_data)

gam = LinearGAM(te(0, 1) + s(2) + s(3) + s(4) + s(5) + s(6) + s(7) + s(8) + s(9) +s(10), n_splines=[50, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20], dtype=['numerical', 'categorical', 'numerical', 'numerical', 'numerical', 'numerical', 'numerical', 'numerical', 'numerical', 'numerical', 'numerical'])
gam.gridsearch(X, y)
...
tester = [50625,1,22,5.1,0,64,5.6,3,0.7,20000,20,20]
...
tester = [29121,0,264,11.9,0,69,9.6,4,0.0,60000,38,40]
