...
gam = LinearGAM(te(0, 1) + s(2) + s(3) + s(4) + s(5) + s(6) + s(7) + s(8) + s(9), n_splines=[50, 20, 20, 20, 20, 20, 20, 20, 20, 20], dtype=['numerical', 'categorical', 'numerical', 'numerical', 'numerical', 'numerical', 'numerical', 'numerical', 'numerical', 'numerical'])
gam.gridsearch(X, y)
...
# (38 previous)
# 27,29121,0,22838721,264,11.9,0,69,9.6,4,0.0,60000,-11,1474355121

tester = [29121,0,264,11.9,0,69,9.6,4,0.0,60000]
